...
using Phenomenal.Penguins.Api.Security;
...
builder.Services.AddDbContext<StoreContext>(options => options.UseSqlite("Data Source=../Registrar.sqlite", b => b.MigrationsAssembly("phenomenal.penguins.Api")));
